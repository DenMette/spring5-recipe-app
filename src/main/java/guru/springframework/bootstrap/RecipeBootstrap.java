...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get optionals
        UnitOfMeasure eachUom = unitOfMeasureRepository.findByDescriptionIgnoreCase("Each").orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findByDescriptionIgnoreCase("tablespoon").orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure teapoonUom = unitOfMeasureRepository.findByDescriptionIgnoreCase("teaspoon").orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure dashUom = unitOfMeasureRepository.findByDescriptionIgnoreCase("Dash").orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure pintUom = unitOfMeasureRepository.findByDescriptionIgnoreCase("Pint").orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure cupsUom = unitOfMeasureRepository.findByDescriptionIgnoreCase("cup").orElseThrow(() -> new RuntimeException("Expected UOM Not Found"));

        //get Categories
        Category americanCategory = categoryRepository.findByDescriptionIgnoreCase("American").orElseThrow(() -> new RuntimeException("Expected Category Not Found"));
        Category mexicanCategory = categoryRepository.findByDescriptionIgnoreCase("Mexican").orElseThrow(() -> new RuntimeException("Expected Category Not Found"));
